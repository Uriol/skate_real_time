...
#define ACCEL_X_MIN ((float) -275) // -277, -275, 
#define ACCEL_X_MAX ((float) 253) // 249, 254, 253,
#define ACCEL_Y_MIN ((float) -249) // -256, -258, 252, 250, 249,
#define ACCEL_Y_MAX ((float) 272) // 271, 272, 269, 272
#define ACCEL_Z_MIN ((float) -237) // -237
#define ACCEL_Z_MAX ((float) 248) // 248
...
#define CALIBRATION__MAGN_USE_EXTENDED true
const float magn_ellipsoid_center[3] = {-290.799, -87.3677, -187.794};
const float magn_ellipsoid_transform[3][3] = {{0.859634, -0.00851202, -0.0260847}, {-0.00851202, 0.935795, -0.00454859}, {-0.0260847, -0.00454859, 0.995014}};
// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -34) // -34
#define GYRO_AVERAGE_OFFSET_Y ((float) 36) // 36
#define GYRO_AVERAGE_OFFSET_Z ((float) -10) // -10
